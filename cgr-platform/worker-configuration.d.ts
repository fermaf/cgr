/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 719184014187ea097576b656ff78f260)
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		PINECONE_NAMESPACE: "cgr-mistral-embed-1024";
		EMBEDDING_PROVIDER: "mistral";
		MISTRAL_EMBEDDING_MODEL: "mistral-embed";
		MISTRAL_EMBEDDING_DIMENSIONS: "1024";
		MISTRAL_EMBEDDING_RPM_LIMIT: "60";
		EMBEDDING_VECTOR_SCHEMA: "embedding:v1";
		NVIDIA_EMBEDDING_API_URL: "https://integrate.api.nvidia.com/v1/embeddings";
		NVIDIA_EMBEDDING_MODEL: "nvidia/llama-nemotron-embed-1b-v2";
		NVIDIA_EMBEDDING_DIMENSIONS: "1024";
		NVIDIA_EMBEDDING_RPM_LIMIT: "18";
		LOG_LEVEL: "debug";
		CRAWL_DAYS_LOOKBACK: "30";
		...
		KV_SYNC_WORKFLOW: Workflow<Parameters<import("./src/index").KVSyncWorkflow['run']>[0]['payload']>;
		CANONICAL_RELATIONS_WORKFLOW: Workflow<Parameters<import("./src/index").CanonicalRelationsWorkflow['run']>[0]['payload']>;
		DOCTRINAL_METADATA_WORKFLOW: Workflow<Parameters<import("./src/index").DoctrinalMetadataWorkflow['run']>[0]['payload']>;
		REGIMEN_BACKFILL_WORKFLOW: Workflow<Parameters<import("./src/index").RegimenBackfillWorkflow['run']>[0]['payload']>;
	}
	...
	interface Env {
		...
		MISTRAL_MODEL: "mistral-large-2512";
		PINECONE_INDEX_HOST: "https://cgr-8aea039.svc.aped-4627-b74a.pinecone.io";
		PINECONE_NAMESPACE: "cgr-mistral-embed-1024" | "mistralLarge2512";
		EMBEDDING_PROVIDER: "mistral" | "nvidia";
		MISTRAL_EMBEDDING_MODEL: "mistral-embed";
		MISTRAL_EMBEDDING_DIMENSIONS: "1024";
		MISTRAL_EMBEDDING_RPM_LIMIT: "60";
		EMBEDDING_VECTOR_SCHEMA: "embedding:v1";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APP_TIMEZONE" | "CGR_BASE_URL" | "MISTRAL_API_URL" | "MISTRAL_MODEL" | "PINECONE_INDEX_HOST" | "PINECONE_NAMESPACE" | "EMBEDDING_PROVIDER" | "MISTRAL_EMBEDDING_MODEL" | "MISTRAL_EMBEDDING_DIMENSIONS" | "MISTRAL_EMBEDDING_RPM_LIMIT" | "EMBEDDING_VECTOR_SCHEMA" | "NVIDIA_EMBEDDING_API_URL" | "NVIDIA_EMBEDDING_MODEL" | "NVIDIA_EMBEDDING_DIMENSIONS" | "NVIDIA_EMBEDDING_RPM_LIMIT" | "LOG_LEVEL" | "CRAWL_DAYS_LOOKBACK" | "BACKFILL_BATCH_SIZE" | "BACKFILL_DELAY_MS" | "ANALYTICS_CACHE_TTL_SECONDS" | "GEMINI_RPM_LIMIT_PER_KEY" | "MISTRAL_QUOTA_COOLDOWN_HOURS" | "GEMINI_API_URL">> {}
}
